/* MaskedHeading — media-filled heading with GSAP reveal.
   Integrated from React Bits (open-source), TypeScript conversion.
   Guards added for non-browser test environments (jsdom). */
...
const MaskedHeading = ({
  ...
  const place = useCallback(() => {
    ...
    const s = settingsRef.current as Required<Pick<MaskedHeadingProps,
