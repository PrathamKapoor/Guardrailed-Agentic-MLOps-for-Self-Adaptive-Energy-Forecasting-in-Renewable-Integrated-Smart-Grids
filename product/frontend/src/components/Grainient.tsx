/* Grainient — animated WebGL gradient background with film grain.
   Integrated from React Bits (open-source), TypeScript conversion.
   WebGL/observer guards added for non-browser test environments (jsdom). */
import { useEffect, useRef } from "react";
import { Renderer, Program, Mesh, Triangle } from "ogl";
import type { Renderer as RendererT, Program as ProgramT, Mesh as MeshT } from "ogl";
...
interface GrainientCtx { renderer: RendererT; program: ProgramT; mesh: MeshT }
const ctxMap = new WeakMap<object, GrainientCtx>();
...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      return; // No WebGL (headless/test environment): render nothing.
    }
